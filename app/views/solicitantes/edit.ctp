			...
			<div class="col-md-6">
				<div class="form-group">
					...
					<div class="input-group">
						<input pattern="(0[1-9]|1[0-9]|2[0-9]|3[01]).(0[1-9]|1[012]).[0-9]{4}" name="data[fecha_nac]" id="fecha_nac" value="<?php echo $this->Fechas->voltearFecha($this->data['Estudiante']["fecha_nac"]);?>" type="date" class="form-control" required placeholder="dd/mm/aaaa">
		...
		<div class="row">
			<div class="col-md-6">
				<div class="form-group">
					...
					<input class="form-control" value="<?php echo $est['Academico']['semestre'] ?>" id="semestre" name="data[semestre]" placeholder="Escribe los datos" type="text" required >
				</div>
			</div>
			<div class="col-md-6">
				<div class="form-group">
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		if(<?php echo $est['Estudiante']['residenciado'] ?>==1){
			$("#residenciado").prop("checked", true);
		}

		if(<?php echo $est['Estudiante']['discapacidad'] ?>==1){
			$("#chkdiscapacidad").prop("checked", true);
		}

		if(<?php echo $est['Estudiante']['etnia'] ?>==1){
