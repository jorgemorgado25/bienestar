<?php
	...
	$pdf->Cell(160,6,utf8_decode('NUCLEO: ' . $dependencia['Nucleo']['nombre']),0,1,'C');
	$pdf->Cell(160,6,utf8_decode('DEPENDENCIA: ' . $dependencia['Dependencia']['nombre']),0,1,'C');

	$pdf->Ln(22);

	$pdf->SetFont('Arial','B',12);
	$pdf->Cell(30,6,' ',0,0,'C');
	$pdf->Cell(40,6,'Tipo de Beneficio',1,0,'C',true);
