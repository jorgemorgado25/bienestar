 ...
 */
	Configure::write('Security.salt', 'ayudantiaDYhG93b0qyJfIxfs2guVoUubWwvniR2G0FgaC9mi');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '000000076859309657453542496749683645');
